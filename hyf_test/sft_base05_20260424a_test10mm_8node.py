...
model_path = "/llmit-data/sfteval/ckpts/interns2_preview/sft/base05_dmtp"
work_dir = "/llmit-data/yujiashuo/a3_base05/output/test10mm_8node"
...
num_workers = 4
global_batch_size = 4          # dp_size = 128/sp_size(4) = 32
total_epoch = 1
hf_interval = 10
hf_max_keep = 2
...
model_cfg.text_config.num_hidden_layers = 4
