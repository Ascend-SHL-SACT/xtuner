...
# pip install /mnt/hw-linyifei2/pkgs/pta_0212_tocpu_moni/torch_npu-2.7.1+gitffb4535-cp311-cp311-manylinux_2_28_aarch64.whl
...
# pip install /mnt/hw-linyifei2/pkgs/torch_npu-2.7.1.dev20251101-cp311-cp311-manylinux_2_28_aarch64.whl

# export SWAP_OPTIMIZER=1

# rm -rf /mnt/hwfile/vc-intern-delivery/vl_delivery/ckpts_huawei_debug/internvl3.5_tiny/internvl-241B-sft-tiny-data-cpt-tiny-bs32-epoch1-lr2e-5/xn_1t
...
# export HCCL_ALGO="allgather=level2:pipeline"
...
export PYTHONPATH=/mnt/huawei/wtg/xtuner_1t_xn_0226/xtuner:$PYTHONPATH
