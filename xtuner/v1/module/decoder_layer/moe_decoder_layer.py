...
class MoEDecoderLayer(nn.Module):
    ...
    def _forward(
        ...
        if (
            ...
            # fused_forward returns the legacy 4-tuple; route it through _build_output so the
            # layer's public dict output contract (incl. subclass extras) holds on this path too.
            fused_hidden_states, _, _, _ = fused_a2a_gmm.fused_forward(
                self,
